...
export function PayInvoiceRegistryPanel({
  ...
  return (
    <section
      className="rounded-xl border border-border/60 bg-muted/20 p-4 shadow-sm"
    ...
    >
      ...
      <div className="mt-3 flex gap-2 rounded-lg border border-amber-500/25 bg-amber-500/[0.06] px-3 py-2.5 text-xs text-amber-950 dark:border-amber-500/30 dark:bg-amber-500/[0.08] dark:text-amber-100/95">
        <AlertTriangle
      ...
      <a
        ...
        className="mt-3 inline-flex items-center gap-1.5 break-all text-sm font-medium text-primary underline-offset-4 hover:underline"
      >
